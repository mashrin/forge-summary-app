...
export function sanitizeNodes(nodes, supportedMarks) {
    ...
    nodeNames.forEach(nodeKey => {
        ...
        if (nodeSpec.content) {
            ...
            nodeSpec.content = unsupportedContentKeys.reduce((newContent, nodeName) => sanitizedContent(newContent, nodeName), nodeSpec.content);
        }
