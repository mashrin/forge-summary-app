...
import { addColSpan, removeColSpan } from 'prosemirror-tables';
...
export function applyCellStep(tr, tableRect, cell, cellStep, isDelete, column) {
    ...
    if (cellStep.mergeWith !== undefined) {
        ...
        var cellAttrs = isDelete
            ? removeColSpan(cellNode.attrs, columns)
            : addColSpan(cellNode.attrs, columns);
...
function getOffset(map, cellStep, isDelete) {
    ...
    var _a = __read(getMapFromCellStep(cellStep, isDelete), 3), oldSize = _a[1], newSize = _a[2];
...
export function invertCellStep(doc, getTableRectAndColumn, cellStep, isDelete, stepMap) {
    ...
    var newCellStepInfo = __assign(__assign({}, cellStep), { 
